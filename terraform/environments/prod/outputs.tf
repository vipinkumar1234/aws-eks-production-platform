...
output "app_domain" { value = module.edge.app_domain }
...
output "app_url" { value = module.edge.app_url }
output "cloudfront_distribution_id" { value = module.edge.distribution_id }
output "app_target_group_arn" { value = module.edge.target_group_arn }
output "app_alb_arn" { value = module.edge.alb_arn }
