provider "aws" {
  ...
  default_tags { tags = { ManagedBy = "terraform", Project = var.project, Environment = "dev", Region = var.aws_region, InfraVersion = var.infra_version, Owner = var.owner, CostCenter = var.cost_center } }
}

data "aws_caller_identity" "current" {}

locals {
  name = "${var.project}-${var.region_short_name}-dev"
  tags = { Environment = "dev", Region = var.aws_region, InfraVersion = var.infra_version, Project = var.project, ManagedBy = "terraform", Owner = var.owner, CostCenter = var.cost_center }
}
